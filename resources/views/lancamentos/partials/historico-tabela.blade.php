...
<div class="mt-6 px-1" @click.prevent="
        ...
        // Apenas interceta cliques em links de paginação válidos
        if (target && target.href && !target.classList.contains('disabled')) {
            loadPage(target.href);
        }
     ">
    {{-- Força o Laravel a usar o tema 'bootstrap-5' para o HTML (que o nosso CSS personaliza) --}}
    {!! $lancamentos->links('pagination::bootstrap-5') !!}
</div>