...
<body class="bg-gray-100 font-sans text-gray-800 antialiased">
    <div class="grid grid-cols-1 md:grid-cols-[260px_1fr] h-screen">
        <aside class="bg-white border-r border-gray-200 p-6 flex-col hidden md:flex">
            ...
            <nav class="flex-grow">
                <ul class="space-y-2">
                    {{-- Links com tamanho de fonte padronizado --}}
        ...
        <div class="flex flex-col max-h-screen">
            ...
            <footer class="bg-white border-t border-gray-200 p-4 text-center text-sm text-gray-500 flex-shrink-0">
                &copy; {{ date('Y') }} {{ config('Finance Vision', 'Finance Vision') }}. Todos os direitos reservados.
            </footer>
        </div>
    </div>
</body>
